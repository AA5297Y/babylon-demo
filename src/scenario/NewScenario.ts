      ...
      units: [
        {
          ...
          sensors: [
            {type: "radar", name: 'KLJ-7', passive: false, refreshRate: 1, data: {range1m2: 40, angle: 90, esa: false, defaultRcs: 5, maxRcs: 50}}
          ],
          comms: [
          ...
          propulsions: [
            {type: "jetEngine", name: 'RD93x1', enable: true, acceleration: 1, data: {
              performance: [
                {altitude: 0, speed: [
    ...
    },
    {
      ...
      units: [
        ...
        },
        {
          ...
          rotation: Vector3.Zero(),
          sensors: [
            {type: "radar", name: 'J-20 AESA', passive: false, refreshRate: 1, data: {range1m2: 120, angle: 120, esa: true, defaultRcs: 5, maxRcs: 50}}
          ],
          comms: [
